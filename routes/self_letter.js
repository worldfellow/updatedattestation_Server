...
module.exports = {
    online_payment_challan: function (user_id, application_id, payment_amount, transaction_id, date_time, status_payment, order_id, email_id, callback) {
        ...
        var dir = constant.FILE_LOCATION + 'public/upload/transcript/' + user_id;
        var file_Dir = constant.FILE_LOCATION + 'public/upload/transcript/' + user_id;
        ...
        var fonts = {
            Roboto: {
                normal: constant.FILE_LOCATION + 'public/fonts/Roboto-Regular.ttf',
                bold: constant.FILE_LOCATION + 'public/fonts/Roboto-Medium.ttf',
                italics: constant.FILE_LOCATION + 'public/fonts/Roboto-Italic.ttf',
                bolditalics: constant.FILE_LOCATION + 'public/fonts/Roboto-MediumItalic.ttf'
            }
        };
        var PdfPrinter = require(constant.FILE_LOCATION + 'node_modules/pdfmake/src/printer');
            ...
            content: [
                {
                    ...
                    table: {
                        ...
                        headerRows: 1,
                        body: [
                            ['', { image: constant.FILE_LOCATION + 'public/upload/profile_pic/mu_logo.png', fit: [60, 60], alignment: 'center' }, ''],
...

                {
                    ...
                    table: {
                        ...
                        headerRows: 1,
                        body: [
                            [{ image: constant.FILE_LOCATION + 'public/upload/profile_pic/mu_logo.png', fit: [30, 30] }, { text: '', fontSize: 7, bold: true }, { text: 'University Copy', fontSize: 7, bold: true, margin: [210, 0, 0, 0] }],
...

                {
                    ...
                    table: {
                        ...
                        headerRows: 1,
                        body: [
                            [{ image: constant.FILE_LOCATION + 'public/upload/profile_pic/mu_logo.png', fit: [30, 30] }, { text: '', fontSize: 7, bold: true }, { text: 'Student Copy', fontSize: 7, bold: true, margin: [210, 0, 0, 0] }],
                            ['', { text: 'UNIVERSITY OF MUMBAI', fontSize: 7, bold: true, margin: [0, -20, 0, 0] }, ''],
                            ['', { text: '', fontSize: 7, bold: true, margin: [0, -16, 0, 0] }, ''],
    ...
    instrucationalLetter: function (user_id, application_id, studentName, collegeName, courseName, specialization, passingMonthYear, duration, passingClass, instruction_medium, application_date, subject, subject1, ref_no, callback) {
        ...
        var dir = constant.FILE_LOCATION + 'public/signedpdf/' + user_id;
        var file_Dir = constant.FILE_LOCATION + 'public/signedpdf/' + user_id;
            ...
            content: [
                ...
                // {text:' ',fontSize: 8,bold:true},
                {
                    ...
                    table: {
                        ...
                        headerRows: 1,
                        body: [
                            [{ text: 'Dr. Sunil Patil', fontSize: 12, bold: true }, { rowSpan: 8, image: constant.FILE_LOCATION + 'public/upload/profile_pic/MU Bleu Logo - Letter.png', fit: [100, 100], alignment: 'center' }, { text: 'Department of Students’ Development', bold: true, alignment: 'left' }],
                ...
                },
                {
                    ...
                    table: {
                        ...
                        headerRows: 1,
                        body: [
                            ['', { rowSpan: 2, image: constant.FILE_LOCATION + 'public/upload/profile_pic/STAMP01.png', fit: [85, 85], alignment: 'center' }, { rowSpan: 2, image: constant.FILE_LOCATION + 'public/upload/profile_pic/stamp_design2.png', fit: [130, 80], alignment: 'center' }],//DIRECT SNIPPING TOOL
                            ['', '', '']
                        ]
                    },
                    layout: 'noBorders',
                            ...
                            content: [
                                {
                                    ...
                                    table: {
                                        widths: [310, 300],
                                        body: [
                                            [{ image: constant.FILE_LOCATION + 'public/upload/profile_pic/weslogo.png', fit: [150, 100] }, { text: 'Confirmation of Doctoral degree Conferral', bold: true }],
                                        ]
                                    },
                                },
                                {
                                ...
                                'Applicants Signature dated on : ' + signatureDated,
                                {
                                    ...
                                    image: constant.FILE_LOCATION + 'public/upload/StudentSignature/' + user_id + '/' + wes_data[0].file_name, alignment: 'left', width: 150,
